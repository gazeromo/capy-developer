...
class CliProcessTests(unittest.TestCase):
    def test_cli_and_mcp_work_from_unrelated_directory(self):
        with tempfile.TemporaryDirectory() as temporary_text:
            ...
            self.assertEqual(15, len(lines[1]["result"]["tools"]))
